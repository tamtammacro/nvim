...
if options.status_line.name == "lualine" then
    ...
    lualine.setup()
elseif options.status_line.name == "staline" then
    local success,starline = pcall(require,"staline")

    if not success then return print "starline is not installed" end
